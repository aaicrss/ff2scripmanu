...
local Window = Rayfield:CreateWindow({
    Name = "FusionCheatHub",
    LoadingTitle = "Football Fusion 2 Cheats",
    LoadingSubtitle = "by xAI Developer Mode",
    ConfigurationSaving = {
        Enabled = true,
        FileName = "FusionCheatHub"
    },
    KeySystem = false
})
...
-- Notify User on Load
Rayfield:Notify({
    Title = "FusionCheatHub Loaded",
    Content = "Cheat script loaded successfully. Use the tabs to toggle features.",
    Duration = 5
})
